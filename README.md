# Musinsa_Review
![무신사](https://github.com/user-attachments/assets/24dc0b8c-3a8c-4bf1-b900-e730db1593a6)
## 1. 서론
...
- 쇼핑몰 페이탈리즘의 긍부정 리뷰 살펴보기 <br>
   - 부정리뷰
![페이탈리즘부정리뷰](https://github.com/user-attachments/assets/56ecc565-3163-405a-8fcc-63ddaaba80dc) <br>
사이즈에 대한 부정적인 반응이 많이 나타나는 것을 볼 수 있다.<br>
   - 긍정리뷰
![페이탈리즘긍정리뷰](https://github.com/user-attachments/assets/8946894c-41e1-4bb3-863f-9a3840c51942) <br>
핏에 대한 긍정적인 반응이 많이 나타나는 것을 볼 수 있다.
<br>
별점이 4.0 이상임에도 불구하고 부정적인 리뷰가 많은 경우가 존재한다. 높은 별점을 받았더라도, 소비자들이 경험한 부정적인 측면이 있음을 알 수 있다.
긍정적인 리뷰가 가장 많았던 쇼핑몰인 트릴리온은 배송 부분을 개선하면 소비자들의 반응이 더욱 긍정적으로 바뀔 것으로 예상된다. 반면, 부정적인 리뷰가 가장 많은 쇼핑몰인 페이탈리즘은 옷의 핏을 유지하면서 사이즈에 대한 정보를 정확하게 표기하면 소비자들의 선호도가 높아질 것으로 보인다.
...
<br>
- 긍정리뷰가 가장 많은 상품과 부정리뷰가 가장 많은 상품의 토픽 모델링을 하여 긍정리뷰에 많이 사용된 단어와 부정리뷰에 많이 사용된 단어를 모델링하여 긍정적인 부분에는 어떤 요소가 많은지 부정적인 부분에는 어떤 요소가 있을지 참고할 수 있을 것이다.
